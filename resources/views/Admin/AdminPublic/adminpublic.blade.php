     ...
     <ul class="nav" id="main-menu">
         <li> <a class="cl" href=""><i class="fa fa-dashboard"></i>小组长管理</a>
             <ul class="nav nav-third-level">
                 ...
                 <li> <a href="/zhibanindex" name='12' class="co">设置小组长</a> </li>
                 <li> <a href="/zhibanlist" name='12' class="co">小组长列表</a> </li>
                 <li> <a href="/erroradd" name='12' class="co">失误管理</a> </li>
                 <li> <a href="/errorlist" name='12' class="co">失误列表</a> </li>
